    ...
    const data = {
      ...
      data: {
        ...
        names: [
          ...
          'Extra Diurna al 35%',
          'Extra Nooc Trab Continuo',
          'Extra Ordinaria Diurna',
          'Extra Festiva Diurna',
          'Extra Ordinaria Nocturna',
          'Extra Nocturna al 65%',
          'Extra Campo al 100%',
          'Extra Campo Noc al 150%',
          'Extra Festivo Trab Continuo',
          'Extra Planificada planta',
        ],

...
export class EditPublicationComponent implements OnInit {
  ...
  getEditArticle() {
    this.EditSharedService.getEditNew().subscribe((data: any) => {
      ...
      console.log(this.infoMyPublication)
      ...
      this.tags = this.infoMyPublication.tags;
  ...
  onSubmitSaveChanges(){
   ...
   this.sendObjectEdit={ id: this.idEdit,
     title: this.title, summary: this.summary, body:this.body , tags: [],
     image: this.image };    

...
export class ReportTrainingComponent implements OnInit {
  ...
  public nameReport: string = 'Convenios de capacitación';
  ...
  constructor(private actionDataTableService: DataDableSharedService, public training_report_list: TrainingService) {

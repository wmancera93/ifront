...
@Component({
  selector: 'app-my-request-approvers-logs',
  templateUrl: './my-request-approvers-logs.component.html',
  styleUrls: ['./my-request-approvers-logs.component.css'],
})
export class MyRequestApproversLogsComponent implements OnInit {
  token;
  ...
  getReport() {
    ...
    this.subscriptions = [
      ...this.subscriptions,
      this.reportsHrService.getMyRequestsLogsApprovers(this.userAuthenticated.employee.pernr).subscribe((data: any) => {

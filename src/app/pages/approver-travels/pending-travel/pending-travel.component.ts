...
import { ApproverTravelsService } from '../../../services/approver-travels/approver-travels.service';
...
export class PendingTravelComponent implements OnInit {
  ...
  constructor(public alert: AlertsService,
    public router: Router, public aproversRequestsService: AproversRequestsService, approverTravelsService: ApproverTravelsService) {

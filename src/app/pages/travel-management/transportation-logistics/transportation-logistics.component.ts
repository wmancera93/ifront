...
export class TransportationLogisticsComponent implements OnInit {
  ...
  chargeData() {
    this.fleets = [{
      action_tranportation_index_view: [{ title: "Ver", is_active: true }, { title: "Borrar", is_active: true }, { title: "Editar", is_active: true }],
    ...
    {
      action_tranportation_index_view: [{ title: "Ver", is_active: true }, { title: "Borrar", is_active: true }, { title: "Editar", is_active: false }],
      created_date: "03/10/2018",
      is_avalable: false,
      id: 15,
      destiny: 'BBQ',

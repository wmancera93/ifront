...
export class ConfirmResetAcountComponent implements OnInit {
  ...
  constructor(public alert: AlertsService,
    ...
    this.newPassword=this.translate.app.frontEnd.pages.authentication.confirm_reset_account.new_password;
    this.confirmationPassword=this.translate.app.frontEnd.pages.authentication.confirm_reset_account.confirmation_password;

  ...
  constructor(
    ...
    this.employeeSharedService
      ...
      .subscribe((data: any) => {
        ...
        this.dateAddCompany =
          dateIn[2] + '/' + dateIn[1] + '/' + dateIn[0];

        const dateBorn = data.fecha_nac.split('-');
        this.datebirth =
          dateBorn[2] + '/' + dateBorn[1] + '/' + dateBorn[0];
        ...
        if (
          document.getElementById('modal-' + this.employeeInfo.modal)
            .className !== 'modal show'
        ) {
          document
            .getElementById('btn-' + this.employeeInfo.modal)
            .click();
          document
